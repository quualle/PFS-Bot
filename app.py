...
# IMPORTANT: The following routes have been outsourced to blueprint files:
# 
# To chat_routes.py:
# - /clarify [POST] (handle_clarification)
# - / [GET, POST] (chat)
# - /update_stream_chat_history [POST] (update_stream_chat_history)
# - /get_clarification_response [GET] (get_clarification_response)
# - /clear_chat_history [POST] (clear_chat_history)
#
# To dashboard_routes.py:
# - /get_active_care_stays_now [GET] (get_active_care_stays_now)
# - /get_dashboard_data [GET] (get_dashboard_data)
# - /debug_dashboard [GET] (debug_dashboard)
#
# To user_management.py:
# - /get_username [GET] (get_username)
# - /set_username [POST] (set_username)
# - /check_login (check_login)
# - /reset_session (reset_session)
# - /toggle_notfall_mode [POST] (toggle_notfall_mode)
# - /logout (logout)
# - /login [GET, POST] (login)
# - /admin_login [GET, POST] (admin_login)
#
# To feedback_routes.py:
# - /store_feedback [POST] (store_feedback_route)
...
# Function has been moved to routes/stream_utils.py
...
def test_bigquery():
    try:
        ...
        FROM `gcpxbixpflegehilfesenioren.PflegehilfeSeniore_BI.care_stays` AS cs
        JOIN `gcpxbixpflegehilfesenioren.PflegehilfeSeniore_BI.contracts` AS c ON cs.contract_id = c._id
        JOIN `gcpxbixpflegehilfeSeniore_BI.households` AS h ON c.household_id = h._id
        JOIN `gcpxbixpflegehilfesenioren.PflegehilfeSeniore_BI.leads` AS l ON h.lead_id = l._id
        WHERE l.seller_id = @seller_id
          AND cs.stage = 'Bestätigt'
        """
