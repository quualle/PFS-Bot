        ...
        try:
            ...
            query_patterns = { 
                "common_queries": {
                    ...
                    "get_revenue_current_month_pro_rata": {"sql_template": "SELECT SUM(revenue) FROM revenue WHERE seller_id=@seller_id AND date BETWEEN @start_of_month AND @end_of_month;", "result_structure": {"name": "total_monthly_pro_rata_revenue"}}
                 }
            }
